...
import { Button, Layout, Modal, Form, Table, Space, Input } from "antd";
    ...
    <div className="contract">
      ...
      >
        ...
        <Layout className="site-layout">
          ...
          >
            <p className="header-title">Quản lý hợp đồng chung cư</p>
          </Header>
          <Space style={{ width: 134, margin: 16 }}>
            <Form form={form} component={false}>
              <Input style={{ width: 300, margin: 16 }} placeholder='Tên chủ'
