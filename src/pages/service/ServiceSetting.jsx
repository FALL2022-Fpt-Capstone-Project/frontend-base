                    ...
                    <Content style={{ margin: "10px 16px" }} >
                        <div
                            ...
                            <div style={{ overflow: "auto" }}>
                                <Button htmlType="submit" style={{ float: "right" }} type="primary" form="edit-service">Lưu</Button>
                                <Button href="/service" type="default" style={{ marginRight: 5, float: "right" }}>Quay lại</Button>
                            </div>
                            <Row>
                                <Col span={16}>
                                    <Form
                                    ...
                                    >
                                        {dataApartmentGroup.map((service, index) =>
                                            <Row>
                                                ...
                                                <Col span={8}>
                                                    <Form.Item className="form-item" name="serivce_price"
