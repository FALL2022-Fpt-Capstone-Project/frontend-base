    ...
    const apartmentGroup = async () => {
        ...
        await axios
            ...
            .then((res) => {
                ...
                setDataApartmentGroupSelect(res.data.data.find((obj, index) => obj.group_id === parseInt(state?.group_id)));
                setRoom(
                    res.data.data.find((obj, index) => obj.group_id === parseInt(state?.group_id))?.list_rooms?.filter(
                        (data) => data.room_floor === parseInt(state?.room_floor) && data.contract_id === null
                    )
                );
                setDataAsset(
                    res.data.data
                        .find((obj, index) => obj.group_id === parseInt(state?.group_id))
                ...
                setRoomSelect(res.data.data.find((obj, index) => obj.group_id === parseInt(state?.group_id))?.list_rooms?.find((obj) => obj.room_id === state?.room_id));
                form.setFieldsValue({
