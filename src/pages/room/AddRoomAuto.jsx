...
function AddRoomAuto({ visible, close, data }) {
  ...
  const onFinish = async (e) => {
    ...
    await axios
      .post(ADD_ROOM_PREVIEW, dataSend, {
        headers: {
          ...
          <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }}>
            <Col span={24}>
              <Card className="card">
                ...
                >
                  <Select
                    ...
                    onChange={(e) => {
                      ...
                      formAddRoomAuto.setFieldsValue({
                        roomFloor: listFloor?.map((floor) => floor.value),
                        roomConvention: "",
                      });
                    }}
                  />
                ...
                >
                  <Select mode="multiple" disabled={statusSelectFloor} placeholder="Chọn tầng" options={roomFloor} />
                </Form.Item>
                <Form.Item
                  className="form-item"
                  name="numberOfRoom"
                ...
                >
                  <InputNumber style={{ width: "100%" }} controls={false} placeholder="Nhập số lượng phòng" />
                </Form.Item>
                <Form.Item
                  className="form-item"
                  name="roomConvention"
                ...
                <Row>
                  <Col>
                    <p>
                      <i>
                        <b>Thêm mới phòng nhanh: </b> các thông tin về phòng sẽ tự động được thêm vào giúp việc nhập dữ
                        liệu nhanh hơn
                      </i>
                    </p>
                  </Col>
