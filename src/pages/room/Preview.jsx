...
function Preview(props) {
        ...
        onChange: (selectedRowKeys, selectedRows) => {
            ...
            if (filterSave === undefined) {
                ...
                if (filterSave.roomFloor === '') {
                    ...
                    const mergeRoomSelect = rowSelected.filter(obj => obj.room_floor !== filterSave.roomFloor).concat(selectedRows);
    ...
    useEffect(() => {
        ...
        const expandedKeys = listRoomGenerate.filter(room => room.is_duplicate === true)?.map((obj, index) => {
